...
/*
 * Taken from RGA: https://github.com/AstrqlDev/RoseGoldAddons
 */
...
public class RenderUtils {
    ...
    public static void drawEntityBox(final Entity entity, final Color color, final int width, float partialTicks, final double yMinOffset, final double yMaxOffset, final double scale) {
        if(width == 0) return;
        final RenderManager renderManager = mc.getRenderManager();
        ...
        final AxisAlignedBB axisAlignedBB = new AxisAlignedBB(
                ...
                entityBox.minY - (entity.posY + yMinOffset) + y,
                entityBox.minZ - entity.posZ + z - 0.05D,
                entityBox.maxX - entity.posX + x + 0.05D,
                entityBox.maxY - (entity.posY + yMaxOffset) + y + 0.15D,
                entityBox.maxZ - entity.posZ + z + 0.05D
        ).expand(scale, scale, scale);
    ...
    public static void drawEntityBox(final Entity entity, final Color color, final int width, float partialTicks) {
        drawEntityBox(entity, color, width, partialTicks, 0, 0, 0);
    }
